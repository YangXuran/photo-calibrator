...
type TabMeta = { title: string; meta?: string; icon: string };
...
const INSPECTOR_TAB_META: Record<InspectorTab, TabMeta> = {
  adjust: {
    title: t("labels.adjust"),
  ...
  curves: {
    title: t("labels.curves"),
    icon: svg('<polyline points="3 20 7 14 11 18 16 9 21 5"/>'),
  },
  compose: {
    title: t("labels.compose"),
    icon: svg('<rect x="6" y="4" width="12" height="16" rx="2"/><path d="M3 3v18M21 3v18"/>'),
  },
  ai: {
    title: "AI",
    icon: svg('<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26"/>'),
  },
  export: {
...
export function getInspectorTabMeta(tab: InspectorTab): TabMeta {
